...
exports.signin = (req, res) => {
    ...
    User.findOne({ email }, (err, user) => {
        ...
        // if user is found make sure that email and password ar verified
...
exports.signout = (req,res)=>{
    ...
    return res.json({message:"Signed out successful"})
}
exports.requireSignin = expressJwt({
    // if token is valid, express jwt appends the verified user id
    // in auth key to the request object
    secret: process.env.JWT_SECRET,
    // adding auth to know user is authenticated
    userProperty:"auth"
})

// adding forgot and reset p/w
